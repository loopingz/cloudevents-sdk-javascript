import { isString, isDefinedOrThrow, isStringOrObjectOrThrow } from "../../utils/fun";

const invalidPayloadTypeError = new Error("invalid payload type, allowed are: string or object");
const nullOrUndefinedPayload = new Error("null or undefined payload");
